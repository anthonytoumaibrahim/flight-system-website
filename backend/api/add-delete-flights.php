...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
  ...
  $stmt->bind_param("siisiiiiii", $data['airline_name'], $data['flight_number'], $data['depart_datetime'], $data['arrival_datetime'], $data['flight_price'], $data['available_seats'], $data['flight_status'], $data['departure_airport_id'], $data['aircraft_type_id'], $data['arrival_airport_id']);
